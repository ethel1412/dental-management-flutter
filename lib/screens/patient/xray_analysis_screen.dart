...
class _XrayAnalysisScreenState extends State<XrayAnalysisScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('AI Dental X-ray Analysis'),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              if (_state == _AnalysisState.done && _result != null) _buildResults(),
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'AI results are for informational purposes only. Always consult a licensed dentist for diagnosis.',
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const Text('Analyzing X-ray...',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            const Text(
              'Running AI dental analysis.\nThis may take 10–60 seconds.',
            ...
            Row(
              ...
              children: [
                ...
                _statBadge(
                    ...
                    color: s.diseasedTeeth > 0 ? const Color(0xFFF44336) : const Color(0xFF4CAF50),
              ...
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(_diseaseIcon(disease), color: color, size: 18),
                        const SizedBox(width: 8),
                        Expanded(
                            child: Text(disease,
                                style: const TextStyle(
                                    ...
                                    fontSize: 14))),
                        Text('$count tooth${count > 1 ? 'teeth' : ''}',
                            style: TextStyle(
  ...
  Widget _buildTeethListCard(List<ToothResult> teeth) {
    final filtered = _showDiseased
        ...
        : teeth;
    final sorted = [...filtered]..sort((a, b) => a.fdiNumber.compareTo(b.fdiNumber));
            ...
            if (sorted.isEmpty)
              const Center(
                child: Padding(
                  ...
                  child: Text('No issues found — all detected teeth are healthy!',
                      textAlign: TextAlign.center,
